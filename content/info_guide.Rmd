...
> Plans for DataFest 2021 are being developed. 
...
DataFest 2021 @ CSU, Chico will start with registration and end with awards ceremony in [ARTS 111 ](https://www.csuchico.edu/aaspace/commonspaces/arts/index.shtml). 

### Directions & Maps

* The Arts and Humanities building (ARTS)
    - Is the first building on the left when entering campus by the roundabout. 
    - Is right behind and next to Madison Bear Garden
...
> This is the 2019 schedule. 2021 will be very similar. 

The schedule is at https://chicodatafest.netlify.com/schedule/.

Registration opens at 5pm on Friday. 
...
- Saturday afternoon - group photo. Exact time to be announced via Slack. 
- Sunday 1pm - Presentation submissions due
- Sunday 2pm - Presentations to Judges and awards ceremony

## Food & Caffeine
Our goal is to keep you fed & caffinated all weekend long. Check the Schedule for mealtimes. 
...
PLEASE KEEP THE SECRET UNTIL MAY 4!. Teams that leak the name or any information
